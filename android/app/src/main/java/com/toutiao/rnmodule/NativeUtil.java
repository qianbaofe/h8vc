...
import com.toutiao.R;
import com.toutiao.utils.BarUtils;
import com.toutiao.utils.Utils;
...
public class NativeUtil extends ReactContextBaseJavaModule {
    ...
    public void setContent(final PopupWindow popupWindow,Activity activity,final Promise promise){
        ...
        LinearLayout wechat = (LinearLayout) linearlayout.findViewById(R.id.wechat);
        ...
        LinearLayout moment = (LinearLayout)linearlayout.findViewById(R.id.moment);
